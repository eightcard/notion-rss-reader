...
1. Fork the Project
   ...
   You will use GitHub Actions to feed updates to the article. Therefore, you
   will need to Fork into your repository.
...
4. Get `NOTION_KEY`(Internal Integration Token)
   ...
   Go to Notion's `My integrations` page and set up an integration for
   `Notion RSS Reader`.
...
5. Add `NOTION_FEEDER_DATABASE_ID`, `NOTION_READER_DATABASE_ID`, and
...
7. Enable to "GitHub Actions Workflow" and delete the release workflow file.
   ...
   [here](https://docs.github.com/en/actions/managing-workflow-runs/disabling-and-enabling-a-workflow#enabling-a-workflow).

   Workflow file is only required in the original repository.

8. Add a link to the site you want to get updates from to "Notion's Feeder
   database".

   ![Feeder](https://i.gyazo.com/66ed647bd229354776f626560baf9307.png)

9. Turn on 「Can edit」at Feader & Reader in Notion page and invite with the
   name of the integration you set in 4.
...
10. You can check if the settings are complete by doing a "Feed Cron" from the
    "Actions" tab.
...
See the [open issues](https://bit.ly/361C6zX) for a full list of proposed
...
"enhancement". if you like it, to give the project a star! Thanks again!
...
Project Link:
[https://github.com/watsuyo/notion-rss-reader/](https://bit.ly/3GFCIYq)
